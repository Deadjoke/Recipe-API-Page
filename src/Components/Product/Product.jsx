...
export default function Product(props) {
 ...
 <>
    <div className="meal text-center hover:shadow-xl group hover:scale-105 duration-300 transition-all bg-white p-12 pb-4 rounded-[35px]" >
      ...
      <h3 className="font-semibold -mt-12  tracking-wider text-xl">{meal.strMeal}</h3>
      {meal.strArea && <h5 className="flex justify-center items-center gap-2 text-emerald-600">
      ...
      <button className="text-white bg-emerald-500  mt-4  hover:bg-emerald-600 font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 px-8 py-2 rounded-full">
