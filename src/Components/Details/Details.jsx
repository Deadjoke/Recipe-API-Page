      ...
      <div className="flex gap-4 flex-col lg:flex-row ">
        <div className="lg:w-2/3">
         ...
         <div className="grid gap-4 items-stretch lg:grid-cols-2">
          <div>
            <img className="w-full rounded-2xl mb-8" src={details?.strMealThumb} alt="Migas"/>
            <ul className="flex gap-4 justify-center">
              <li className="bg-red-600 text-white py-2 px-4 rounded-lg ">
                <Link target="_blank" to={details?.strYoutube} className="flex gap-2 justify-center items-center">
              ...
              <li className="bg-emerald-500 text-white py-2 px-4 rounded-lg ">
                  <Link target="_blank" to={details?.strSource} className="flex gap-2 justify-center items-center">
        ...
        <div className="lg:w-1/3 p-4">
         <div className="bg-white rounded-2xl p-4">
            <h3 className="text-2xl font-semibold mb-4 border-bo-4 p-2">Ingredients</h3>
            <div className="flex justify-between p-2 border-bo-2 last-of-type:border-b-0 ">
